...
As Claude Code, please read `SKILL.md` in this directory to understand the commands (`/memoria scan`, `/memoria register`, etc.) and the structure of the configured `collective-memory` database.
