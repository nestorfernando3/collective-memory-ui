...
Archivo vivo de trabajo. Este perfil se entiende por la suma de proyectos académicos, pedagógicos, culturales y de desarrollo que comparten métodos, temas y trayectorias en el Caribe colombiano.

## Identidad de trabajo

- Docente / Investigador en Politécnico de la Costa Atlántica (vigente)
- Docente / Gestor en I.E.D. Brisas del Río (vigente)
...
- Programación Web (JS, VITE, React, Supabase)
- Redacción Académica y Científica
- Formulación de Proyectos Cultura/Educación
- Docencia
- Estadística
- React
- Vite
